                ...
                <div class="collapse navbar-collapse d-flex justify-content-center" id=navbarNav>
                    <div class="col-6">
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item me-4">
                                <a href="{{route('enrolledCoursesPage', Auth::user()->id)}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Courses</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('InstructorList')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Instructors</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('assignmentRelatedPage')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Assignments</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('studentMailBoxPage')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>MailBox</b></a>
                            </li>
                    </div>
                    ...
                    <ul class="navbar-nav col-3 offset-1 d-flex justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item mb-2 text-muted" href="{{route('studentManageProfilePage')}}"><i
                                            class="fa-solid fa-user me-2" style="color: rgb(11, 36, 92)"></i><span
                                            style="color: rgb(11, 36, 92)">View Profile</span></a></li>
                                <li><a class="dropdown-item text-muted" href="{{route('studentEditProfilePage')}}"><i
            ...
            <div class="col-2 bg-white d-none d-lg-block">
                <nav class="navbar position-fixed">
                    <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item mb-2"><a href={{route('enrolledCoursesPage', Auth::user()->id)}}
