                    ...
                    <div class="col-5">
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item me-4">
                                <a href="{{route('user#dashboard')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Home</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('instructorCourseRelatedPage')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Courses</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('instructorAssignmentRelatedPage')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Assignments</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('enrolledStudentListPage')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Students</b></a>
                            </li>
                            <li class="nav-item me-4">
                                <a href="{{route('chooseCourseforGrades')}}" class="nav-link navFont"
                                    style="color: rgb(11, 36, 92)"><b>Grades</b></a>
                            </li>
                    </div>
                    ...
                    <ul class="navbar-nav col-3 offset-1 d-flex justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item mb-2 text-muted" href="{{route('instructorManageProfilePage')}}"><i
                                            class="fa-solid fa-user me-2" style="color: rgb(11, 36, 92)"></i><span
                                            style="color: rgb(11, 36, 92)">View Profile</span></a></li>
                                <li><a class="dropdown-item text-muted" href="{{route('instructorEditProfilePage')}}"><i
            ...
            <div class="col-2 bg-white d-none d-lg-block">
                <nav class="navbar position-fixed">
                    <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                        <li class="nav-item mb-2"><a href={{route('user#dashboard')}}
                        ...
                        <li class="nav-item mb-2"><a href={{route('instructorCourseRelatedPage')}}
                        ...
                        <li class="nav-item mb-2"><a href="{{route('instructorAssignmentRelatedPage')}}"
                                class="nav-link text-decoration-none ms-3 ms-xl-4 fs-xl-5 fs-6">
                                <i class="fa-solid fa-file-invoice me-2" style="color: rgb(11, 36, 92)"></i>
                                <span style="color: rgb(11, 36, 92)">Assignments</span></a></li>
                        <li class="nav-item mb-2"><a href={{route('enrolledStudentListPage')}}
                                class="nav-link text-decoration-none ms-3 ms-xl-4 fs-xl-5 fs-6">
                                <i class="fa-solid fa-user-graduate me-2" style="color: rgb(11, 36, 92)"></i>
                                <span style="color: rgb(11, 36, 92)">Students</span></a></li>
                        <li class="nav-item mb-2"><a href="{{route('chooseCourseforGrades')}}"
                                class="nav-link text-decoration-none ms-3 ms-xl-4 fs-xl-5 fs-6">
                                <i class="fa-solid fa-user-graduate me-2" style="color: rgb(11, 36, 92)"></i>
                                <span style="color: rgb(11, 36, 92)">Grades</span></a></li>
                        <li class="nav-item dropdown">
