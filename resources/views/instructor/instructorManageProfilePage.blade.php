...
@section('content')
    ...
    <div class="row my-4 d-flex justify-content-evenly">
        <a href="{{ route('instructorEditProfilePage') }}" class="card col-10 px-5 py-4 text-decoration-none">
            <div class="row">
                <div class="col-12 px-5 text-muted">
    ...
    <div class="row my-4 d-flex justify-content-evenly">
        <a href="{{route('instructorChangePasswordPage')}}" class="card col-10 px-5 py-4 text-decoration-none">
            <div class="row">
                <div class="col-12 px-5 text-muted">
