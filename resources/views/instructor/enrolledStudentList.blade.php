...
@section('content')
    <div class="container-fluid col-lg-11 col-12  mt-3">
        ...
        <h1 class="text-center my-4 navFont" style="color: rgb(11, 36, 92)">Enrolled Student List</h1>
        <table class="table table-striped text-center">
            <thead>
                <tr>
                    <th class="text-muted">Student Name
    ...
    <script>
               ...
               // Function to append sorted data to the table
                    function sortData(column, order) {
                        $.ajax({
                            url: '{{ route("sortStudentList") }}',
                            method: 'GET',
                            dataType: 'json',
                            data: {
                                column: column,
