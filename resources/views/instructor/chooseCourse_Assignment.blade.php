...
{{-- @section('breadcrumb')
    <div class="row">
        <div class="mt-3" id="breadcrumb">{!! Breadcrumbs::render('instructor.chooseCourse',Auth::user()->id) !!}</div>
    </div>
@endsection --}}
        ...
        <div class="row " id="eventContainer">
            @foreach ($courses as $course)
                <div class="col-12 col-md-6 col-lg-4 mb-3">
                 <a href="{{route('uploadedAssignmentsPage', $course['id'])}}" class="text-decoration-none">
